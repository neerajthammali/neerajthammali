  ...
  return (
    <section id="newsletter" className="w-full py-16 md:py-24">
      <div className="container mx-auto px-4 md:px-6">
        <div className="mx-auto max-w-5xl overflow-hidden rounded-2xl bg-gradient-to-r from-primary/10 via-background to-accent/10 p-1 transition-all duration-300 hover:shadow-2xl hover:shadow-primary/20">
