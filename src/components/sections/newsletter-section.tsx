  ...
  return (
    <section id="newsletter" className="w-full py-16 md:py-24">
      <div className="container mx-auto px-4 md:px-6">
        <div className="mx-auto max-w-5xl overflow-hidden rounded-2xl bg-gradient-to-r from-blue-500/10 via-background to-purple-500/10 p-1 transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/20">
                ...
                <div className="grid md:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="w-full">
                         <form className="flex flex-col sm:flex-row items-center gap-4">
                            ...
                            />
                            <Button type="submit" size="lg" className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-primary-foreground">
