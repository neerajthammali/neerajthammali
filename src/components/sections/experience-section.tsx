            ...
            <div className="space-y-12">
              {experiences.map((exp, index) => (
                <div key={index} className="relative flex items-start gap-6 group">
                   <div className="absolute left-0 top-0 flex items-center justify-center w-12 h-12 bg-background rounded-full transition-transform duration-300 group-hover:scale-110">
                     {exp.icon}
                   </div>
                  <div className="pl-16">
